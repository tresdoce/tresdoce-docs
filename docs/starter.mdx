...
shields:
    - name: NodeJS
      src: https://img.shields.io/static/v1.svg?style=flat&label=Node&message=v14.15.4&labelColor=339933&color=757575&logoColor=FFFFFF&logo=Node.js
    - name: Npm
      src: https://img.shields.io/static/v1.svg?style=flat&label=Npm&message=v6.14.10&labelColor=CB3837&logoColor=FFFFFF&color=757575&logo=npm
    - name: NestJS
      src: https://img.shields.io/static/v1.svg?style=flat&label=NestJs&message=v8.2.6&labelColor=E0234E&logoColor=FFFFFF&color=757575&logo=Nestjs
    - name: Latest Release
      src: https://img.shields.io/github/v/tag/rudemex/nestjs-starter?label=release
      link: https://github.com/rudemex/nestjs-starter/releases/latest
      target: _blank
    - name: License
      src: https://img.shields.io/github/license/rudemex/nestjs-starter?style=flat
      link: https://github.com/rudemex/nestjs-starter/blob/master/license.md
      target: _blank
      break: true
    - name: GitHub Workflow Status
      src: https://github.com/rudemex/nestjs-starter/actions/workflows/master.yml/badge.svg?branch=master
      link: https://github.com/rudemex/nestjs-starter/actions/workflows/master.yml
      target: _blank
    - name: Coverage
      src: https://img.shields.io/codecov/c/github/rudemex/nestjs-starter?logoColor=FFFFFF&logo=Codecov&labelColor=#F01F7A
      link: https://app.codecov.io/gh/rudemex/nestjs-starter/
      target: _blank
    - name: SonarCloud
      src: https://sonarcloud.io/api/project_badges/measure?project=rudemex_nestjs-starter&metric=alert_status
      link: https://sonarcloud.io/summary/new_code?id=rudemex_nestjs-starter
      target: _blank
    - name: Snyk
      src: https://snyk.io/test/github/rudemex/nestjs-starter/badge.svg
      link: https://snyk.io/test/github/rudemex/nestjs-starter
      target: _blank
---
...
import ContainerShields from "../src/components/Containers";

<Header>
    <img alt="nestjs-starter" width="250" height="auto" src="/img/nestjs-logo.svg"/>
    <h1>NestJS Starter</h1>
</Header>

<ContainerShields align="center"/>
...
- [🥳 Demo](https://rudemex-nestjs-starter.herokuapp.com/v1)
- [🤓 Objetivo](#objective)
...
- [📄 Changelog](https://github.com/rudemex/nestjs-starter/blob/master/CHANGELOG.md)
- [📜 License MIT](https://github.com/rudemex/nestjs-starter/blob/master/license.md)
...
`API_PREFIX`: Es el prefijo que hace referencia a la api, y alimenta otros módulos, como es el de los filter
exceptions.

- Type: `String`
- Default: `API-PREFIX`

`CONTEXT`: Es el contexto el que se puede acceder a la API del servidor, de esta manera no se exponen los endpoints
en
...
`ORIGINS`: Es una whitelist para que la aplicación sólo pueda ser consumida por urls confiables y evitar cualquier
tipo
...
A modo de ejemplo, se pueden cargar todas las variables de entorno que requieras, es importante seguir con el
esquema
...
All notable changes to this project will be documented in [Changelog](https://github.com/rudemex/nestjs-starter/blob/master/CHANGELOG.md) file.

---

<div align="center">
    <a href="mailto:mdelgado@tresdoce.com.ar" target="_blank" alt="Send an email">
        <img src="/img/logo-mex-red.svg" width="120" alt="Mex"/>
    </a><br/>
    <p>Made with ❤</p>
</div>
